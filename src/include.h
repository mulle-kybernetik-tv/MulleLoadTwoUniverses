#ifndef mulle_load_two_universes_include_h__
#define mulle_load_two_universes_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "MulleLoadTwoUniverses-include.h" to keep the #include statements in the
...
#include "_MulleLoadTwoUniverses-include.h"
