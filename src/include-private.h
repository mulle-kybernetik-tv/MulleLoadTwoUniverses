#ifndef mulle_load_two_universes_include_private_h__
#define mulle_load_two_universes_include_private_h__
...
#include "_MulleLoadTwoUniverses-include-private.h"
